...
const HomePage = () => {
    ...
    // useEffect for auto-cycling core values
    useEffect(() => {
    ...
    // useEffect for scrolling active core value card
    useEffect(() => {
    ...
    useEffect(() => {
        const observer = new IntersectionObserver(
            ...
            { rootMargin: '0px', threshold: 0.15 } // Trigger when 15% is visible
        );

        const elementsToAnimate = document.querySelectorAll('.animate-entry');
        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* MODIFICATION: Added smooth scrolling for the entire page */
                    html {
                    ...
                    .stagger-children.visible > *:nth-child(1) { transition-delay: 0.2s; }
                    .stagger-children.visible > *:nth-child(2) { transition-delay: 0.4s; }
                    ...
                    .hero-section { padding: 1rem 1.5rem; max-width: 100%; margin: 0 auto; }
                    ...
                    .hero-content {
                        ...
                        position: relative;
                        min-height: 550px;
                        background-image: url('/Affexmedia icons/Landing page girl.png');
                    ...
                    .hero-text h2 {
                        font-weight: 600;
                        font-size: clamp(2rem, 7vw, 3rem); /* Mobile font size */
                        margin-bottom: 0.5rem;
                    }
                    .hero-text p {
                        font-weight: 500;
                        font-size: clamp(1rem, 4vw, 1.5rem); /* Mobile font size */
                        color: var(--brand-dark);
                    }
                    
                    .connecting-text-container { position: relative; text-align: center; background-color: var(--secondary-light-gray); width: 100%; }
                    /* MODIFICATION: Changed flex-direction and added gap */
                    .connecting-text { 
                        padding: 2rem 1.5rem; 
                        display: flex; 
                        flex-direction: column; 
                    ...
                    .services-section h2 {
                        font-size: clamp(2.5rem, 8vw, 4.0625rem);
                    }
                    ...
                    .mission-vision-section { padding: 4rem 1.5rem; max-width: 1280px; margin: 0 auto; display: flex; flex-direction: column; gap: 5rem; }
                    ...
                    /* CORE VALUES CAROUSEL - UPDATED FOR MOBILE */
                    ...
                    .values-row-container::-webkit-scrollbar {
                        display: none; /* Hides scrollbar on Chrome/Safari */
                    }
                    .values-row {
                        display: flex;
                        gap: 1.5rem;
                        /* Padding creates space on the left of the first card and right of the last */
                        padding: 0 10%;
                        justify-content: flex-start; /* Aligns cards for the carousel */
                    }
                    .value-card {
                        flex-shrink: 0;
                        width: 80%; /* Each card takes up 80% of the container's width */
                        height: 250px;
                        display: flex;
                        flex-direction: column;
                        justify-content: center;
                        ...
                        /* This is the key: it centers the card when the user stops scrolling */
                    ...
                    .services-section { padding: 3rem 1.5rem; max-width: 100%; margin: 0 auto; text-align: center; }
                    .services-section h2 { margin-bottom: 3rem; }
                    .services-buttons { display: flex; flex-direction: column; align-items: center; gap: 1rem; margin: 0 auto 2rem; max-width: 1280px; }
                    ...
                    .service-button:hover { transform: scale(1.02) translateY(-5px); background-color: var(--secondary-light-gray); }
                    .get-quote-button { padding: 1rem 2rem; background-color: var(--brand-primary); color: var(--brand-light); border-radius: 9999px; box-shadow: 0 10px 15px rgba(0, 0, 0, 0.1); border: none; cursor: pointer; transition: opacity 0.3s ease, transform 0.3s ease; text-decoration: none; display: inline-block; }
                    .get-quote-button:hover { opacity: 0.9; transform: scale(1.03) translateY(-3px); }
                    ...
                    @media (min-width: 768px) {
                        ...
                        .hero-content {
                            ...
                            align-items: center;
                            min-height: 600px;
                            background-size: contain; /* RESTORES OLD LAYOUT */
                            background-position: right center; /* RESTORES OLD LAYOUT */
                        }
                        .hero-text {
                            text-align: left;
                            max-width: 40%;
                        ...
                        .hero-text h2 {
                            font-size: clamp(2.5rem, 8vw, 4.0625rem); /* RESTORES OLD FONT SIZE */
                        }
                        .hero-text p {
                            font-size: 28px; /* RESTORES OLD FONT SIZE */
                        }

                        /* ADDED: Restore desktop layout for Core Values */
                        .values-row {
                            justify-content: center;
                            max-width: 1280px;
                            margin: 0 auto;
                            padding: 0 1.5rem; /* Restore original padding */
                        }
                        .value-card {
                            width: 250px; /* Restore original fixed width */
                        }
                        ...
                        .services-buttons { flex-direction: column; gap: 1.5rem; }
                    ...
                    @media (min-width: 1024px) {
                        ...
                        .value-card { min-width: 300px; width: 300px; } /* Explicitly set width */
                    }
                `}
            </style>
            ...
            <main className="main-content">
                <section id="home" className="hero-section">
                    <div className="hero-content">
                        <div className="hero-text animate-entry stagger-children">
                            <div className="hero-promise">
                                <h2>Brand Promise</h2>
                                <p>Strategic clarity. Creative impact. Real results.</p>
                            </div>
                            <div className="hero-teamwork">
                                <h2>Teamwork</h2>
                                <p>When you reach out, we’re ready to roll. We don’t wait, we act.</p>
                            </div>
                        </div>
                    </div>
                    <div className="connecting-text-container animate-entry">
                        <div className="connecting-text">
                            <h3>CONNECTING B2C!</h3>
                            {/* --- MODIFICATION: Added button to navigate to WorksPage --- */}
                            <Link to="/WorksPage" className="get-quote-button">
                                See What We’ve Done
                            </Link>
                        </div>
                    </div>
                </section>
                <section id="about" className="about-section animate-entry">
                ...
                <section id="mission-vision" className="mission-vision-section">
                    <div className="mission-block animate-entry">
                    ...
                    <div className="vision-block animate-entry">
                        <div className="text-content">
                             <h3>Vision</h3>
                            <p>
                ...
                <section id="core-values" className="core-values-section">
                    <h2 className="animate-entry">
                        <span className="heading-thin-black">Our </span>
                        <span>Core Values</span>
                    </h2>
                    <div ref={coreValuesRef} className="values-row-container animate-entry">
                ...
                <section id="services" className="services-section animate-entry">
                    <h2>Services</h2>
                    <div className="services-buttons">
                         {servicesLinks.map((service) => (
                             <Link key={service.name} to={service.path} className="service-button">
                                  {service.name}
                             </Link>
                         ))}
                    </div>
                ...
                <div className="footer-container">
                    ...
                    <div className="footer-column">
                        ...
                        <ul>
                            ...
                            {/* MODIFICATION: Changed href to scroll to the services section */}
