        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* PM Page Content Specific Styles */
                    .pm-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; }
...
<Link to="/WorksPage">Works</Link>
            ...
            <main className="pm-page-content">
                ...
                <h4 className="section-heading">Our Performance Marketing Service Helps You:</h4>
                <p style={{ fontSize: '24px', fontWeight: 500, lineHeight: 1.6, maxWidth: '70rem', textAlign: 'center', margin: '1.5rem auto 50px' }}>
                    ...
                    {serviceIcons.map((item, index) => (
                        <div key={index} className="icon-item">
                            <div className="icon-image-wrapper">
                                <img src={item.iconPath} alt={item.name.props.children.join('')} />
                            </div>
                            <h4>{item.name}</h4>
                        </div>
                    ))}
                ...
                <div className="action-section">
                    <h3 className="section-heading">Ready to Grow with Confidence?</h3>
