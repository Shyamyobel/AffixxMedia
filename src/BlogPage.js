...
// Using a structured array for blog posts including the full content for in-page expansion.
const blogPosts = [
    { 
        id: 1, 
...
// --- BLOG CARD COMPONENT WITH EXPANDABLE CONTENT ---
const BlogCard = ({ post, index }) => {
    ...
    // Intersection Observer for the "Fluid Grid Reveal" animation
    useEffect(() => {
    ...
    // Style for smooth entry animation
    const cardStyle = {
    ...
    return (
        ...
        >
            <div className="card-header" style={{ backgroundColor: 'var(--brand-primary)' }}>
                ...
                {/* Removed read time per user request */}
            </div>
            ...
            <style>
                {`
                    ...
                    .blog-hero p {
                        ...
                        font-weight: 300; /* Light/Thin for contrast */
                        max-width: 700px;
                        margin: 0 auto 3rem;
                    }
                    ...
                    .filter-button.active {
                        ...
                        font-weight: 600;
                        box-shadow: 0 4px 8px rgba(37, 164, 173, 0.3);
                    }
                    ...
                    /* Blog Card Styling (Fluid Grid Reveal + EXPANDABLE) */
                    .blog-card {
                    ...
                    .card-category {
                        padding: 2px 8px;
                        border-radius: 4px;
                        /* Kept single brand color, per request 3 */
                        background-color: var(--brand-primary); 
                    }
            ...
            <main className="main-content">
                ...
                <section className="blog-grid">
                    {filteredPosts.length > 0 ? (
                        ...
                        <p className="w-full text-center text-lg text-gray-500 col-span-full">No blog posts found for this category.</p>
                    )}
                </section>
            </main>
