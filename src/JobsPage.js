            ...
            <style>
                {`
                    ...
                    .nav-links-center a, .nav-contact-link, .services-dropdown-trigger {
                        ...
                        padding: 0.5rem 0; background: none; border: none; font-family: inherit; cursor: pointer;
                    }
                    ...
                    <div className="nav-links-mobile">
                        ...
                        <div className="mobile-services-list">
                            ...
                            {servicesLinks.map((service) => (
                                <Link key={service.name} to={service.path} className="mobile-service-item" onClick={toggleMobileMenu}>
                                    {service.name}
                                </Link>
                            ))}
                        </div>
