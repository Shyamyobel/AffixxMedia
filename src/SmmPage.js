...
const SmmPage = () => {
    ...
    // Ref for dropdown click-outside-to-close functionality
    ...
    // Data for the services dropdown in the header
    const servicesLinks = [
        {
    ...
    // Data for the footer social links
    ...
    // Data specific to the SMM Page
    const smmIcons = [
        { name: <>Reach your <br />target<br /> audience</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/target-audience-icon.svg' },
        { name: <>Increase<br />brand<br /> visibility</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/brand-awareness.png' },
        { name: <>Build trust<br />and<br />engagement</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/commitment-icon.svg' },
        { name: <>Drive website<br />traffic and<br />conversions</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/web-traffic.png' },
    ];

    const resultsIcons = [
        { name: <>Engagement<br />growth</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/Group 1000001637.svg' },
        { name: <>Follower<br />trends</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/growth.png' },
        { name: <>Top-performing<br />content</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/high-performance.png' },
        { name: <>Recommendations<br />to improve</>, iconPath: '/Affexmedia icons/Affexmedia icons/SMM Service/3117328-200.svg' },
    ];
        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* --- SMM PAGE CONTENT SPECIFIC STYLES (UPDATED) --- */
                    .smm-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; }
                    ...
                    .icon-image-wrapper { position: relative; width: 80px; height: 80px; margin-bottom: 1rem; }
                    .icon-image-wrapper img { width: 100%; height: 100%; display: block; }
                    .icon-item:hover .icon-image-wrapper { animation: wiggle 0.5s ease-in-out; }
...
<Link to="/WorksPage">Works</Link>
            ...
            {/* SMM Page Content */}
            <main className="smm-page-content">
                <h2 className="page-title">
                    <span>Social Media</span> Marketing
                </h2>
                <p className="page-intro">
                    Build a brand. Grow your audience. Convert followers into customers with<br />AffixxMedia’s strategic Social Media Marketing solutions.
                </p>

                <div className="text-section">
                    <h3 className="section-heading">Why Social Media Marketing?</h3>
                    <p>
                        Your customers are scrolling every day, every hour. Brands that show up consistently, creatively,<br /> and strategically on platforms like Instagram, Facebook, LinkedIn, and YouTube are the ones<br /> that capture attention and drive results.
                    </p>
                </div>

                <h3 className="section-heading">Our social media marketing services help you:</h3>
            
                <div className="icon-grid">
                    {smmIcons.map((item, index) => (
                ...
                <div className="text-section">
                    <h3 className="section-heading">Real Results. Real Growth.</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '55rem' }}>
    We don’t just post — we perform. Every month, you’ll receive a detailed analytics report that shows:
</p>
                </div>
                ...
                <div className="action-section">
                    <h3 className="section-heading">Ready to Elevate Your Brand on Social Media?</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '70rem', margin: '1.5rem auto 3rem' }}>
                        Let’s turn scrolls into sales. Book your free strategy session with our team today.
                    </p>
