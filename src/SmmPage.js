        ...
        <div className="app">
            <style>
                {`
                    ...
                    .smm-page-content { padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; overflow: hidden; }
            ...
            <header className="header">
                <nav className="nav-container">
                    ...
                    <div className="nav-links-center">
                        ...
                        >
                            <motion.button whileHover={{ y: -2 }} className="services-dropdown-trigger">
                                Services
                            </motion.button>
                            <AnimatePresence>
            ...
            <main className="smm-page-content">
                ...
                <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Our social media marketing services help you:</motion.h3>
                ...
                <motion.div className="action-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Ready to Elevate Your Brand on Social Media?</motion.h3>
