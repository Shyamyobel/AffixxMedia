...
const WorksPage = () => {
    ...
    // --- REFS ---
    const dropdownRef = useRef(null); // Ref for the services dropdown
    ...
    // ✨ INNOVATION: Staggered entry animations on scroll
    useEffect(() => {
        ...
        // Apply observer to each element with a staggered delay
    ...
    return (
        <div className="app">
            <style>
                {`
                    /* --- FONT DEFINITIONS (Consistent with other pages) --- */
                    @font-face { font-family: 'Gilroy'; src: url('/font/Gilroy-Regular.ttf') format('truetype'); font-weight: 400; font-display: swap; }
                    @font-face { font-family: 'Gilroy'; src: url('/font/Gilroy-SemiBold.ttf') format('truetype'); font-weight: 600; font-display: swap; }
                    @font-face { font-family: 'Gilroy'; src: url('/font/Gilroy-Bold.ttf') format('truetype'); font-weight: 700; font-display: swap; }
                    ...
                    .works-section {
                        ...
                        max-width: 900px;
                        margin: 0 auto;
                        text-align: center; /* Center align content for a focused look */
                    }
                    .works-section h1 {
                ...
                <nav className="nav-container">
                    ...
                    <div className="nav-links-center">
                        ...
                        <div className="services-dropdown-container" ref={dropdownRef}>
                            <button className="services-dropdown-trigger" onClick={() => setIsServicesDropdownOpen(!isServicesDropdownOpen)}>
                                Services
                            </button>
                    ...
                    <div className="nav-links-mobile">
                        ...
                        <div className="mobile-services-list">
                            ...
                            {servicesLinks.map((service) => (
                                <Link key={service.name} to={service.path} className="mobile-service-item" onClick={toggleMobileMenu}>{service.name}</Link>
                            ))}
                        </div>
                        <Link to="/WorksPage" onClick={toggleMobileMenu}>Works</Link>
                        <Link to="/BlogPage" onClick={toggleMobileMenu}>Blogs</Link>
            ...
            <main className="main-content">
                <section className="works-section">
                    ...
                    <div className="animated-divider animate-entry"></div>
