...
const ImPage = () => {
    ...
    const serviceIcons = [
        { name: <span style={{ fontWeight: 500 }}>Find the<br /> right<br /> influencers</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/influencer.png' },
        { name: <span style={{ fontWeight: 500 }}>Create impactful<br /> brand<br /> campaigns</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/campaign.png' },
        { name: <span style={{ fontWeight: 500 }}>Drive reach<br /> and<br /> engagement</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/engagement.png' },
        { name: <span style={{ fontWeight: 500 }}>Build credibility<br /> with audiences</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/trust.png' },
    ];

    const resultsIcons = [
        { name: <span style={{ fontWeight: 500 }}>Reach new<br /> loyal<br /> followers</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/customer-care.png' },
        { name: <span style={{ fontWeight: 500 }}>Boost product<br /> awareness<br /> quickly</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/brand-awareness (1).png' },
        { name: <span style={{ fontWeight: 500 }}>Gain trust<br /> through<br /> creators</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/trust (1).png' },
        { name: <span style={{ fontWeight: 500 }}>Drive<br /> actions<br /> and sales</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Influencer Marketing Service/drive.png' },
    ];
        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* IM Page Content Specific Styles */
                    .im-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; }
                    .page-title { font-size: 58px; margin-bottom: 2.5rem; text-align: center; font-weight: 500; color: var(--brand-primary); }
                    .page-intro { text-align: center; max-width: 60rem; margin: 1rem auto 3rem auto; font-size: 24px; line-height: 1.6; color: var(--brand-dark); }
                    ...
                    .text-section p { font-size: 22px; line-height: 1.6; max-width: 65rem; margin: 1.5rem auto 0; text-align: center;}
            ...
            {/* IM Page Content */}
            <main className="im-page-content">
                <h2 className="page-title">
                    Influence <span>Marketing</span>
                </h2>
                <p className="page-intro">
                    Build trust and boost visibility by partnering with creators your audience already<br/> follows and believes in.
                </p>

                <div className="text-section">
                    <h3 className="section-heading">Why Influence Marketing?</h3>
                    <p>
                        People trust people, not ads all the time. Collaborating with the right influencers helps your brand<br /> reach new audiences, create authentic conversations, and drive meaningful actions — all<br /> while staying relevant and engaging.
                    </p>
                </div>

                <h4 className="section-heading">Our Influence Marketing Service Helps You:</h4>
                ...
                <div className="text-section">
                    <h3 className="section-heading">Real Results. Real Influence.</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '55rem' }}>
                        From strategy to execution, we manage the full campaign process while you focus on brand growth. You will:
                    </p>
                </div>
                ...
                <div className="action-section">
                    <h3 className="section-heading">Ready to Grow Through Influence?</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '55rem', margin: '1.5rem auto 3rem' }}>
                        Let the right voices grow your brand. Book a free strategy call with our team today.
                    </p>
