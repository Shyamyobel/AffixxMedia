        ...
        <div className="app">
            <style>
                {`
                    ...
                    .im-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; overflow: hidden; /* Prevent horizontal scrollbar from animations */ }
            ...
            <main className="im-page-content">
                <motion.div variants={staggerContainer} initial="hidden" animate="show">
                    <motion.h2 className="page-title" variants={fadeInUp}>
                        Influencer <span>Marketing</span>
                    </motion.h2>
                ...
                <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={staggerContainer}>
                    <motion.h4 className="section-heading" variants={fadeInUp}>Our Influence Marketing Service Helps You:</motion.h4>
                ...
                <motion.div className="text-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Real Results. Real Influence.</motion.h3>
                ...
                <motion.div className="action-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Ready to Grow Through Influence?</motion.h3>
                    <motion.p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '55rem', margin: '1.5rem auto 3rem' }} variants={fadeInUp}>
