...
const SeoPage = () => {
    ...
    const serviceIcons = [
        { name: <span style={{ fontWeight: 500 }}>Improve rankings on<br /> search engines</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/search-engine.png' },
        { name: <span style={{ fontWeight: 500 }}>Increase website<br /> traffic organically</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/web-traffic (2).png' },
        { name: <span style={{ fontWeight: 500 }}>Reach high-intent<br /> audiences</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/target-audience-icon.svg' },
        { name: <span style={{ fontWeight: 500 }}>Build long-term<br /> credibility</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/credibility.png' },
    ];

    const resultsIcons = [
        { name: <span style={{ fontWeight: 500 }}>Rank for<br /> target keywords</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/focus-target-keyword-icon.svg' },
        { name: <span style={{ fontWeight: 500 }}>Increase<br /> website visibility</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/high-visibility.png' },
        { name: <span style={{ fontWeight: 500 }}>Boost quality<br /> organic traffic</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/organic-traffic.png' },
        { name: <span style={{ fontWeight: 500 }}>Improve conversions<br /> over time</span>, iconPath: '/Affexmedia icons/Affexmedia icons/SEO service/good-conversion-rate.png' },
    ];
        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* SEO Page Content Specific Styles */
                    .seo-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; }
                    .page-title { font-size: 58px; margin-bottom: 2.5rem; text-align: center; font-weight: 500; color: var(--brand-primary); }
                    .page-intro { text-align: center; max-width: 60rem; margin: 1rem auto 3rem auto; font-size: 24px; font-weight: 500; line-height: 1.6; color: var(--brand-dark); }
...
<Link to="/WorksPage">Works</Link>
            ...
            <main className="seo-page-content">
                ...
                <p className="page-intro">
                    Rank higher, get discovered, and turn search traffic into steady business growth with<br /> AffixxMedia’s advanced SEO solutions.
                </p>

                <div className="text-section">
                    <h3 className="section-heading">Why SEO?</h3>
                    <p>
                        Every day, your potential customers are searching for the services you offer. SEO helps your<br /> business appear when it matters most—on top of search engine results. It is one of the most<br /> cost-effective ways to grow long-term visibility, traffic, and leads.
                    </p>
                </div>

                <h4 className="section-heading">Our SEO Service Helps You:</h4>
                ...
                <div className="text-section">
                    <h3 className="section-heading">Real Results. Real Visibility.</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '65rem' }}>
                         Our SEO strategies are driven by deep research, technical expertise, and continuous<br /> improvement. You will:
                    </p>
                </div>
                ...
                <div className="action-section">
                    <h3 className="section-heading">Ready to Grow Through Search?</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '75rem', margin: '1.5rem auto 3rem' }}>
                         Let your business show up where it counts. Book a free SEO strategy session with<br /> our team today.
                    </p>
