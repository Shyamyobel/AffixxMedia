...
const SeoPage = () => {
        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* Add all other font faces as needed */
    ...
    transition: opacity 0.3s ease; 
                    ...
                    .seo-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; overflow: hidden; }
                    .page-title { font-size: 58px; margin-bottom: 2.5rem; text-align: center; font-weight: 500; }
                    .page-intro { text-align: center; max-width: 60rem; margin: 1rem auto 3rem auto; font-size: 24px; font-weight: 500; line-height: 1.6; }
            ...
            <main className="seo-page-content">
                ...
                <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={staggerContainer}>
                    <motion.h4 className="section-heading" variants={fadeInUp}>Our SEO Service Helps You:</motion.h4>
                ...
                <motion.div className="text-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Real Results. Real Visibility.</motion.h3>
                    <motion.p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '65rem' }} variants={fadeInUp}>
                ...
                <motion.div className="action-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Ready to Grow Through Search?</motion.h3>
                    <motion.p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '75rem', margin: '1.5rem auto 3rem' }} variants={fadeInUp}>
