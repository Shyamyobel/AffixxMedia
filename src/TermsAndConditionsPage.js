        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* --- TERMS AND CONDITIONS STYLES (Similar to Privacy Policy) --- */
                    .terms-section {
                        padding: 3rem 1.5rem;
                        max-width: 900px;
                        margin: 0 auto;
                    ...
                    /* Ensure number is visible and correctly styled */
                    .terms-section h2::before {
                        ...
                        font-weight: 700;
                        font-size: 1.5em;
                        opacity: 0.5; /* Slight opacity for background effect, as seen in image */
                    }
                    ...
                    /* Custom bullet point using a tiny, subtle dot */
