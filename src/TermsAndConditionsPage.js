...
const TermsAndConditionsPage = () => {
    ...
    // The comprehensive list of services mentioned in the text
    const detailedServices = [
        'Social Media Marketing', 'Personal branding', 'Video production',
        'Advertisements', 'Performance Marketing', 'Influencer Marketing',
        'SEO', 'Guerrilla Marketing', 'Website & App Development',
        'Film Promotions', 'Short Form Content (UGC)', 'UI/UX Design',
    ];
        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* --- GLOBAL STYLES (COPIED FROM HOME PAGE) --- */
                    :root {
                    ...
                    /* --- HEADER & NAV STYLES (COPIED FROM HOME PAGE) --- */
                    ...
                    .mobile-submenu.open { max-height: 500px; /* Adjust as needed */ }
    ...
    transition: opacity 0.3s ease; 
                    ...
                    .terms-section { padding: 3rem 1.5rem; max-width: 900px; margin: 0 auto; font-size: 18px; line-height: 1.6; }
                    .terms-section h1 { font-size: clamp(2.5rem, 6vw, 4.0625rem); font-weight: 600; color: var(--brand-primary); margin: 0 0 1rem; }
                    .terms-section .welcome-text { font-size: 20px; color: var(--brand-dark); font-weight: 500; margin-bottom: 2rem; }
                    .terms-section h2 { font-size: 28px; font-weight: 600; color: var(--brand-dark); margin: 2.5rem 0 0.5rem; padding-left: 10px; }
                    .terms-section p { font-size: 18px; font-weight: 400; color: var(--brand-dark); line-height: 1.6; margin-bottom: 1rem; }
                    .terms-section ul { list-style-type: none; padding-left: 0; margin-bottom: 2rem; }
                    .terms-section li { margin-bottom: 0.4rem; font-size: 18px; line-height: 1.6; color: var(--brand-dark); position: relative; padding-left: 20px; }
                    .terms-section li::before { content: '-'; position: absolute; left: 0; color: var(--brand-primary); font-weight: 600; top: 0; }
                    .terms-section hr { border: none; border-top: 1px solid #E5E7EB; margin: 3rem 0; }
            ...
            <main className="main-content">
                <section className="terms-section">
                    <h1>
                        <span>Terms</span> <span style={{fontWeight: 300, color: '#313131' }}>and</span> <span>Conditions</span>
                    </h1>
                    <p className="welcome-text">Welcome to Affixmedia. By accessing our website affixxmedia.com and using our services, you agree to the following terms and conditions.</p>
                    ...
                    <p>Clients must provide accurate and timely information, access, and materials required to execute services. Delays due to client-side lapses are not our responsibility.</p>

                    <h2>3. Payments</h2>
                    <p>All projects require advance payment as per the agreed proposal. Ongoing services will follow a monthly billing cycle unless otherwise stated.</p>

                    <h2>4. Intellectual Property</h2>
                    <p>Unless otherwise agreed, all final deliverables are the client's property upon full payment. We reserve the right to showcase work for portfolio and promotional purposes.</p>

                    <h2>5. Confidentiality</h2>
                    <p>We maintain strict confidentiality of all sensitive client data and project-related materials unless required by law.</p>

                    <h2>6. Limitations of Liability</h2>
                    <p>We are not liable for indirect, incidental, or consequential damages arising from the use or inability to use our services.</p>

                    <h2>7. Termination</h2>
                    <p>We reserve the right to terminate services if a client breaches our terms, fails to make timely payments, or engages in unethical practice.</p>

                    <h2>8. Governing Law</h2>
                    <p>These terms are governed by the laws of Puducherry/India.</p>
                </section>
            </main>
