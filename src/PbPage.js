...
const PbPage = () => {
    ...
    const toggleMobileMenu = () => {
        ...
        },
        {
            ...
            icon: <svg xmlns="http://www.w.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" /></svg>
        },
        {
        ...
        },
        {
            ...
            icon: <svg viewBox="0 0 24 24" fill="currentColor" height="1em" width="1em"><path d="M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m5.231 13.481L15 17.25m-4.5-15H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9zm3.75 11.625a2.625 2.625 0 11-5.25 0 2.625 2.625 0 015.25 0z" /></svg>
        }
    ];
    ...
    const serviceIcons = [
        { name: <span style={{ fontWeight: 500 }}>Content<br/> planning and<br/> scripting</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/content-plan.png' },
        { name: <span style={{ fontWeight: 500 }}>Professional<br/> video shoot<br/> sessions</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/video-shooting.png' },
        { name: <span style={{ fontWeight: 500 }}>High-quality<br/> video editing</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/video-editor.png' },
        { name: <span style={{ fontWeight: 500 }}>Platform-based<br/> publishing<br/> guidance</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/content-editing.svg' },
    ];

    const resultsIcons = [
        { name: <span style={{ fontWeight: 500 }}>Establish niche<br/> thought<br/> leadership</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/thought-leadership.png' },
        { name: <span style={{ fontWeight: 500 }}>Build trust<br/> with<br/> audience</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/credibility.png' },
        { name: <span style={{ fontWeight: 500 }}>Drive<br/> conversations<br/> through content</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/conversation.png' },
        { name: <span style={{ fontWeight: 500 }}>Attract leads<br/> and visibility</span>, iconPath: '/Affexmedia icons/Affexmedia icons/Personal Branding Service/2.png' },
    ];
    ...
    text-align: center;
    max-width: 60rem;
    /* This margin correctly positions the text */
    ...
    color: var(--brand-dark);
                    ...
                    /* PB Page Content Specific Styles */
                    .pb-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; }
                    .page-title { font-size: 58px; margin-bottom: 2.5rem; text-align: center; font-weight: 500; color: var(--brand-primary); }
                    .page-intro { font-weight: 500; text-align: center; max-width: 60rem; margin: 1rem auto 3rem auto; font-size: 24px; line-height: 1.6; color: var(--brand-dark); }
                    .text-section { margin-bottom: 3rem; }
                    .section-heading { font-weight: 500; font-size: 31px; color: var(--brand-primary); text-align: center; margin-bottom: 3rem; }
                    ...
                    .icon-item h4 { font-weight: 600; font-size: 24px; color: var(--brand-dark); }
                    .action-section { text-align: center; margin-top: 3rem; }
                    .action-button { padding: 1rem 2rem; background-color: var(--brand-primary); color: #fff; font-size: 1.125rem; font-weight: bold; border: none; border-radius: 9999px; cursor: pointer; transition: opacity 0.3s ease; text-decoration: none; display: inline-block; }
                    .action-button:hover { opacity: 0.9; }

                    /* --- MODIFIED STYLES FOR ICON HOVER --- */
                    @keyframes wiggle {
                    ...
                    .icon-item:hover .icon-image-wrapper {
            ...
            <main className="pb-page-content">
                ...
                <p className="page-intro">
                    Position yourself as an industry leader and grow a powerful online presence with <br />AffixxMedia’s personal branding content system.
                </p>

                <div className="text-section">
                    <h3 className="section-heading">Why Personal Branding?</h3>
                    <p>
                        Today’s audiences connect with people, not just logos. Whether you are a founder, coach,<br /> consultant, or expert, building a personal brand online helps you gain trust, attract<br /> opportunities, and create real impact.
                    </p>
                </div>

                <h4 className="section-heading">Our Personal Branding Service Helps You:</h4>
               <p style={{ fontSize: '24px', fontWeight: 500, lineHeight: 1.6, maxWidth: '70rem', textAlign: 'center', marginBottom: 50 }}>
    We take care of everything from strategy to execution so you can focus on what matters most. <br />Our team builds your brand presence with clarity, consistency, and creativity.
                ...
                <div className="text-section">
                    <h3 className="section-heading">Real Results. Real Authority.</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '55rem' }}>
                        Build a personal brand that positions you as a leader in your space. With a consistent and strategic content approach, you will:
                    </p>
                </div>
                ...
                <div className="action-section">
                    <h3 className="section-heading">Ready to Build Your Personal Brand with Impact?</h3>
                    <p style={{ fontSize: '26px', fontWeight: 500, lineHeight: 1.6, maxWidth: '70rem', margin: '1.5rem auto 3rem' }}>
                        Let your voice lead your growth. Book a free strategy session with our team today.
                    </p>
                    <a href="#" className="action-button">Book Your Free Call Now</a>
                </div>
            </main>
