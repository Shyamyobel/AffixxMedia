        ...
        <div className="app">
            <style>
                {`
                    ...
                    /* --- PB PAGE SPECIFIC STYLES --- */
                    .pb-page-content { flex-grow: 1; padding: 3rem 1.5rem; max-width: 1280px; margin: 0 auto; overflow: hidden; /* Added overflow hidden */ }
                    ...
                    .service-intro-text { font-size: 22px; text-align: center; max-width: 60rem; margin: -1.5rem auto 3rem; line-height: 1.6; color: var(--brand-dark); }
            ...
            <header className="header">
                {/* Header JSX now with motion enhancements */}
                            ...
                            <motion.div className="mobile-menu-panel" initial={{ x: '100%' }} animate={{ x: '0%' }} exit={{ x: '100%' }} transition={{ type: 'spring', stiffness: 300, damping: 30 }} onClick={(e) => e.stopPropagation()}>
                                ...
                                <ul className="mobile-nav-links">
                                    ...
                                    <li>
                                        ...
                                        <ul className={`mobile-submenu ${isMobileServicesOpen ? 'open' : ''}`}>{servicesLinks.map(service => (<li key={service.name}><Link to={service.path} onClick={toggleMobileMenu}>{service.name}</Link></li>))}</ul>
                                    </li>
            ...
            <main className="pb-page-content">
                ...
                <motion.div initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.3 }} variants={staggerContainer}>
                    <motion.h4 className="section-heading" variants={fadeInUp}>Our Personal Branding Service Helps You:</motion.h4>
                    <motion.p className="service-intro-text" variants={fadeInUp}>
                ...
                <motion.div className="text-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Real Results. Real Authority.</motion.h3>
                ...
                <motion.div className="action-section" initial="hidden" whileInView="show" viewport={{ once: true, amount: 0.5 }} variants={staggerContainer}>
                    <motion.h3 className="section-heading" variants={fadeInUp}>Ready to Build Your Personal Brand with Impact?</motion.h3>
